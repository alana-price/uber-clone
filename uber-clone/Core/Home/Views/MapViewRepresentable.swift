...
struct MapViewRepresentable: UIViewRepresentable {
    ...
    @EnvironmentObject var locationViewModel: LocationSearchViewModel // Casting
...
extension MapViewRepresentable {
    ...
    class MapCoordinator: NSObject, MKMapViewDelegate {
        ...
        // Access user location and create region on MapView to zoom in and display location
